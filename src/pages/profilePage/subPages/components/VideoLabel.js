...
const VideoLabel = (props) => {
  return (
    <div className="w-11/12 bg-gray-300 h-24 mx-auto flex flex-row gap-6 justify-between rounded-md">
      <img
      ...
      <div className="flex flex-col gap-3 pt-3 ml-4  text-left">
        <p className="text-lg text-green-700 font-bold">0 likeów</p>
        <p className="text-lg text-red-700 font-bold">0 dislików</p>
      </div>
