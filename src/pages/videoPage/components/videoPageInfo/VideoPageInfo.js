    ...
    return (
        <div className="flex lg:gap-10 mt-16 lg:mt-0 lg:mb-0 lg:pt-0 text-gray-300 h-12 gap-4 items-center">
            <div className="justify-self-start w-1/2 sm:w-1/3 relative h-full"> 
                    <p className="text-2xl font-bold lg:ml-auto my-auto md:absolute md:right-1/4 p-1 whitespace-nowrap">Tytuł filmu jakiś</p>
            </div>
            <div className="w-1/2 sm:w-1/3 flex h-full pr-2 py-2"> 
                <div className="bg-green-500 w-1/2 text-lg font-semibold center h-full select-none cursor-pointer
                ...
                <div className="bg-red-600 w-1/2 text-lg font-semibold center h-full select-none cursor-pointer
