...
const LoginForm = ({ isVisable, visabilityCallback, forgotCallback }) => {
  ...
  return (
    <div
      ...
      <button
        onClick={() => handleLogin()}
        className="mt-10 border-4 rounded-md bg-gray-200 w-1/2 sm:w-1/4 mx-auto dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-400 hover:border-6 hover:border-gray-400 text-lg font-bold hover:text-white">
        {" "}
        Zaloguj{" "}
      </button>
      ...
      <button
        ...
        className="mt-auto mb-4 mr-4 border-4 rounded-md bg-gray-200 w-2/3 dark:bg-gray-700 dark:text-gray-200 sm:w-1/4 ml-auto hover:bg-gray-400 hover:border-6 hover:border-gray-400 text-lg font-bold hover:text-white">
        {" "}
        Rejestracja{" "}
      </button>
    </div>
