  ...
  return (
    <div
      ...
      <p
        ...
        className="mx-auto text-sm font-italic cursor-pointer hover:underline mt-2">
        {" "}
        Przypomnij hasło{" "}
      </p>
      <button
        onClick={() => handleLogin()}
        className="mt-10 border-4 rounded-md bg-gray-200 w-1/2 sm:w-1/4 mx-auto hover:bg-gray-400 hover:border-6 hover:border-gray-400 text-lg font-bold hover:text-white">
        {" "}
        Zaloguj{" "}
      </button>
