  ...
  return (
    <div className="mt-12 pt-16 w-full dark:bg-gray-800 sm:mt-14 md:mt-16 lg:mt-0">
      {location.pathname.includes("search/") ? (
        <div className="flex flex-row mx-auto w-max text-lg">
          {" "}
          <div className=""> Wyszukiwane hasło: </div> <div className="ml-2 font-bold">{param}</div>
        </div>
      ) : (
        ""
      )}
      ...
      {typeof data === "undefined" && !loading ? (
        <div className="text-lg font-bold"> Nie odnaleziono filmów </div>
      ) : (
        ""
      )}
