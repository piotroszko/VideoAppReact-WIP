  ...
  return (
    <div className="bg-white dark:bg-gray-500">
            ...
            <div className="relative w-64 flex justify-start items-center">
              <input
                ...
                className="w-full py-3 bg-gray-100 rounded pl-10
                            focus:outline-none text-sm leading-none text-gray-600 placeholder-gray-600"
                type="text"
                placeholder="Search"
              />
              <svg
      ...
      <div className="lg:hidden h-full">
        <div
          className={`py-4 px-4 z-50 h-auto fixed top-0 md:px-6 w-full flex justify-between items-center bg-white border-b border-gray-100`}>
          <div
            id="searchItems"
            className={`${
              search ? "hidden" : ""
