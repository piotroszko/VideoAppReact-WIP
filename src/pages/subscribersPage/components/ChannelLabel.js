...
const ChannelLabel = (props) => {
  return (
    <div className="dark:hover:text-gray-900 flex flex-row pb-1 pt-1 text-black dark:text-gray-200 hover:text-gray-300 hover:bg-gray-500 border-b-2 border-gray-400 shadow-inner cursor-pointer">
      ...
      <div className="relative hidden order-1 ml-2 text-left sm:block sm:w-3/4">
        ...
        <p className="hidden text-gray-400 text-xs italic md:block">
          {props.subs ? props.subs.substring(0, 20) + "" : "0"}
        </p>
      </div>
    </div>
  );
